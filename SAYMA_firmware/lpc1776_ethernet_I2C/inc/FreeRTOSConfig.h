/*
    FreeRTOS V7.4.2 - Copyright (C) 2012 Real Time Engineers Ltd.
...
#include "system_LPC177x_8x.h" // for SystemCoreClock
...
#define configLWIP_TASK_PRIORITY					( 4U )
#define configSOFTRTC_TASK_PRIORITY					( 5U )
#define configSYSLOG_WRITE_TASK_PRIORITY			( 0 )

#define conifgTCPIP_TASK_STACK_SIZE					( configMINIMAL_STACK_SIZE * 2UL )

#define configCOMMAND_INT_MAX_OUTPUT_SIZE ( 512u )

/*----------------------------------------------------------
 * Additional timers API
 *----------------------------------------------------------*/
